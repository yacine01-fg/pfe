...
namespace PFE.Controllers
{
    public class DepartementsController : Controller
    {
        ...
        public DepartementsController(PostgresContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var departement = await _context.Departements
                .FirstOrDefaultAsync(m => m.Iddept == id);
            if (departement == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Iddept,Nomdept")] Departement departement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Iddept,Nomdept")] Departement departement)
        {
            if (id != departement.Iddept)
            {
                return NotFound();
            }
